# Available .SHOPPING One-Word Domains (31,308)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-31%2C308%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **31,308 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 31,308 domains · **Median ask:** $23.50 · **High-demand under $2,500:** 1
...
| fund.shopping  | premium   | $520      | $520          | medium         | low    | 4      | namecheap                                               |
...
| motor.shopping | resell    | —         | —             | high           | low    | 5      | Porkbun LLC                                             |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 31,308 live domains                        |
...
> Unique Domains. *Available .SHOPPING One-Word Domains*. Version 2026-09-24. Public GitHub extract for the exact Unique Domains search represented by this repository.
