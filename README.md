...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C306%20rows-8250df">
...
> **Important:** this repository is a **public 9,306-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,008 domains** on the canonical page below.

**Public extract:** 9,306 rows · **Live catalog:** 5,622,008 domains
...
- `shopping.csv` — public CSV extract (9,306 rows)
- `shopping.json` — public JSON extract (9,306 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,306-row public sample | 5,622,008 live domains                           |
...
> Unique Domains. *Available .SHOPPING One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
